(function ($) {
    ...
    gDocument.ready(function () {
       ...
       /* Module Tab*/
        $('.gutentor-module-tabs-item').on('click', function (e) {
            let gThis = $(this);
            var gThisIndex = gThis.index();
            if(gThis.hasClass('gutentor-tabs-nav-active')){
                return;
            }
            gThis.addClass('gutentor-tabs-nav-active');
            gThis.siblings().removeClass('gutentor-tabs-nav-active');
            gThis.closest('.gutentor-module-tabs-wrap').find('.gutentor-module-tabs-content.gutentor-tabs-content-active').removeClass('gutentor-tabs-content-active');
            gThis.closest('.gutentor-module-tabs-wrap').find('.gutentor-module-tabs-content').eq(gThisIndex).addClass('gutentor-tabs-content-active');
            e.preventDefault();
        });
